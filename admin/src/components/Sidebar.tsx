...
const icons: Record<string, React.ReactNode> = {
  ...
  compass: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <polygon points="10.5,5.5 6.5,7 5.5,10.5 9.5,9" fill="currentColor" fillOpacity="0.3" stroke="currentColor" />
    </svg>
  ),
  settings: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  dollar: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M8 1v14" />
      <path d="M11.5 4H6.25a2.25 2.25 0 000 4.5h3.5a2.25 2.25 0 010 4.5H4.5" />
    </svg>
  ),
  speaker: (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { id: "scene", label: "场景短语", icon: "compass" },
    ],
  },
  {
    title: "智能",
    items: [
      ...
      { id: "tts", label: "TTS\u8BED\u97F3", icon: "speaker" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "finance", label: "财务管理", icon: "dollar" },
    ],
  },
  {
    title: "系统",
